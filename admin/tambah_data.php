                    ...
                    <div class="content">
                        <div class="container">
                            <div class="text-center mb-4">
                                ...
                                <p class="text-muted">Silahkan tambahkan Guru baru untuk mengajar di SMAN 1 Tanjung Bumi</p>    
                            </div>
                        </div>
                        <div class="container d-flex justify-content-center">
                            <form action="add_guru.php" method="POST" style="width: 50vw; min-width: 300px;">
