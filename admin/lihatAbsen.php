...
<head>
    ...
    <title>ABG-SMANTAB | Data Absensi</title>
               ...
               <?php include('partials/navbar.php'); ?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="text-center h3 mb-2 text-gray-800">
                        <h3>Data Absensi Guru SMAN 1 Tanjung Bumi</h3>    
                    </div>
                    <div class="text-center mb-4">
                       <p class="text-muted">merupakan Detail data-data Absensi Guru SMAN 1 Tanjung Bumi </p> 
                    </div>
                    <!-- DataTales Example -->
                            ...
                            <table class="table table-success table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="dataabsen.php?id=<?=$row['NIP'];?>" class="btn btn-info">Lihat Absensi</a>
